...
author: "Introduction à l'analyse de données avec R<br>
  ...
  <br>
  <a href='https://j-ramalho.github.io/I2R_FR/'>
...
<ul>
  <li class="m1"><span>L'atelier comprend cinq <high>blocs R d'une demi-heure </high>(en gris).</span></li>
  <li class="m2"><span>Blöcke</span></li>
  <ul class="level">
    <li><span><high>Introduction </high>basée sur slides (10min)</span></li> 
    <li><span><high>Exercice </high>individuel (15min)</span></li> 
    <li><span><high>Solution </high>interactive (5min)</span></li> 
  </ul>
</ul>
...
<h1><a href=https://therbootcamp.github.io/I2R_2022Apr/index.html>Agenda</a></h1>
