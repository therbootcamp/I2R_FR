...
```{r message=FALSE}
# Charger la table de Wikipédia (n'oubliez pas les paquets)
...
R et RStudio fournissent également d'excellents outils pour créer<high>Rapports</high>, <high>Slides</high>, et même <high>des sites Web</high>. 
...
[Google](www.google.com), [DuckDuckGo](duckduckgo.com). Assurez-vous que *R* ou *Rproject* est mentionné dans votre recherche.

<br>
<font size = 4><i>Souvent, vous serez redirigé vers:</i></font>

[R-bloggers](www.r-bloggers.com) informations sur les derniers développements R (comprend une newsletter).

[Stackoverflow](https://stackoverflow.com/questions/tagged/r) est une page pour les problèmes R avec des solutions proposés par d'autres utilisateurs. Essayez de publier un problème vous-même. Souvent, vous obtenez des réponses étonnamment rapidement.
...
<table class="tg"  style="cellspacing:0; cellpadding:0; border:none">
  ...
  <th class="tg-yw4l" valign='top'>
    ...
    <a href="www.joao-ramalho.ch"><b>joao-ramalho.ch</b></a><br>
    <font size=4><i>packages: </i></font> 
    <a href="https://cran.r-project.org/web/packages/industRial/index.html"><b>industRial</b></a> <br>
    </p>
  </th>
